              ...
              <div className="flex items-center justify-center gap-1.5 sm:gap-2">
                 ...
                 <p
                    className={`text-2xl sm:text-4xl font-bold tracking-tight ${
                      displayYouOweBusiness ? "text-red-600" : "text-green-600"
                    }`}
                  >
            ...
            {mounted && (
              <p
                className={`text-xs sm:text-sm font-medium ${
                  youOweBusiness ? "text-red-600/80" : "text-green-600/80"
                }`}
              >
                {businessOwesYou ? "Business Owes You" : youOweBusiness ? "You Owe Business" : "Even"}
              </p>
            )}
            {mounted && (
